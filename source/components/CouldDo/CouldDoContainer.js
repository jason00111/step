...
import CloudDo from './CouldDo'

export default class CloudDoContainer extends GlobalStateComponent {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    const text = this.state.couldDos[projectId][currentCouldDoIndex]
